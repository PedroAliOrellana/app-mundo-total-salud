...
<script>
  ...
  export default {
    ...
    beforeMount: async function (){
      ...
      const resGet = await axios('http://159.203.124.21:3000/bancosSuscriptor/'+ afiliado._id)
    ...
    methods:{        
        ...
        eliminar: async function(id){
          ...
          if(prueba){             
             try {
                const resPut = await axios.delete('http://159.203.124.21:3000/bancosSuscriptor/'+ id,{
                        headers:{
        ...
        guardar:async function(){
          ...
          if(this.banco._id == ''){              
              ...
              try{
                const resPost = await axios.post('http://159.203.124.21:3000/bancosSuscriptor',data,{
                        headers:{
                            Authorization: 'Bearer '+ localStorage.getItem('token')
                        } 
                    })
              ...
              try {
                const resPut = await axios.put('http://159.203.124.21:3000/bancosSuscriptor/'+ this.banco._id,data,{
                        headers:{
                            Authorization: 'Bearer '+ localStorage.getItem('token')
                        } 
                    })
