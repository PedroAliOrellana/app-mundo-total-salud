        ...
        <base-nav class="navbar-top navbar-horizontal navbar-dark"
            ...
            <template v-slot="{closeMenu}">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link nav-link-icon" to="/identifcacion/register">
                            <i class="ni ni-circle-08"></i>
                            <span class="nav-link-inner--text">Registro</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link nav-link-icon" to="/identifcacion/login">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            ...
                            <p class="text-lead text-white">Gracias por acceder a Total Salud.</p>
                        </div>
                    </div>
                </div>
            </div>
