                   ...
                   <!--  <li class="nav-item">
                        <a class="nav-link"
                           href="https://demos.creative-tim.com/vue-argon-dashboard/documentation">
                            <i class=""><font-awesome-icon icon="share-alt"/></i><strong>  Redes Sociales</strong> 
                        </a>
                    </li> -->
                    <!-- <li class="nav-item">
                        <a class="nav-link"
                    ...
                    <li class="nav-item" @click="limpiarLocal">
                        <a class="nav-link"
                           href="/identifcacion/login">
                          <i class=""><font-awesome-icon icon="sign-out-alt"/></i><strong>     Cerrar Sesión</strong>
                        </a>
                    </li>
                </ul>
            </div>
